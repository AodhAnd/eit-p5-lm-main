...
void PI_controller(){
  ...
  const float Kp = .8; //2.0576; //.8;     // Tuned parameters: Kp = .8 and Ki = 6
  const float Ki = 6; //9.7517; //6;       // For time constant equal to that of the plant Kp = 2.0576 and Ki = 9.7517
