...
Hs = (8.5009000*10^7*z^4+3.40036000*10^8*z^3+5.10054000*10^8*z^2+3.40036000*10^8*z+8.5009000*10^7)/(6.409771488*10^8*z^4+2.89406448*10^8*z^3+3.528796704*10^8*z^2+6.2980752*10^7*z+1.389038080*10^7)
[num,den] = tfdata(Hs);
