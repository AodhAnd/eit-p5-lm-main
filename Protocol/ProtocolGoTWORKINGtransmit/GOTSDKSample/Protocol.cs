...
namespace GOTSDKSample
{
    class Protocol
    {
        ...
        private BitArray ChecksumGenerator(BitArray protocolData) //generates the Checksum
        {
            int i = 0;
            int j = 0;
        ...
        private BitArray CarryAdd(BitArray temp) //The carries which can occure when summing the bitarrays of 20 is added to the summed bitarray
        {
            int i = 0;
            bool Carry = false;
        ...
        private BitArray SumOfbitArrays(BitArray BitArray1, BitArray BitArray2, BitArray BitArray3) //The three bit arrays of 20 is summed together
        {
            int i = 0;
            bool Carry = false;
        ...
        private int NegToPos(int Number) //implements the signbit into a negative number
        {
            if (Number < 0)
            {
        ...
        private BitArray IntToBitA(int Number, int Lenght)   //converts integer to a certain length bitarray.
        {
